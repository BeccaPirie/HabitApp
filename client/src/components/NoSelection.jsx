        ...
        <NoSelectionStyled>
            <Paper className="paper">
                <div className="content">
                    <p>
                    This web app has been designed as part of my Honours Project for Computing (Application Software Development). 
                    The aim of the project was to build a tool to help aid habit formation as building and maintaining new habits 
                    can be challenging for many. Other applications designed to support habit formation, although popular, often 
                    lack the tools to integrate new habits into daily routine. Therefore, my goal was to find ways an application 
                    could be used to successfully aid the habit formation process.
                    </p>
                    ...
                    thoughts regarding the foods you are trying to cut back on.
                    </p>
